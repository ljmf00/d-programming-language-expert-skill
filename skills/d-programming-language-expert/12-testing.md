...
name: d-lang-testing
description: >-
  D testing: unittest blocks, pre/post-condition contracts, class and
  struct invariants, contract inheritance, assert messages,
  std.experimental.testing. Use when writing tests or verifying D code
  correctness. DDoc lives in 15-documentation.md.
license: MIT
metadata:
  topics: testing unittest contracts invariants assert
  order: 12
---

# D Testing

Comprehensive guide to D's testing infrastructure and contract programming. For DDoc comments, macros and embedded examples see [15-documentation.md](15-documentation.md).
