...
| File                                                       | Module                      | When to load                                                                                                                                                                                                                               |
| ---------------------------------------------------------- | --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [12-testing.md](12-testing.md)                             | **Testing**                 | `unittest` blocks (advanced patterns), pre/post-condition `in`/`out` contracts, invariants, contract inheritance, `assert` messages, `std.experimental.testing`. Use when writing tests.                                                    |
| [15-documentation.md](15-documentation.md)                 | **Documentation (DDoc)**    | DDoc comment syntax, `Params:`/`Returns:`/`Throws:` sections, macros (`$(D ...)`, `$(REF ...)`, `$(LINK2 ...)`), section organization, embedded and extractable code examples, HTML generation. Use when writing or reviewing documentation comments. |
